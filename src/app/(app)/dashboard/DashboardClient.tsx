...
import { Profile, AmbitionTask, AmbitionMilestone, Ambition } from "@/src/types";
    ...
    <div className="flex flex-col gap-8 pb-10 overflow-auto p-6 md:p-8 pt-6">
      ...
      >
        ...
        <Card.Card>
          ...
          <Card.CardContent className="pb-2">
            <Progress
              value={(completedTasksAndMilestones / totalTasksAndMilestones) * 100}
              className="h-2"
            />
            <p className="text-xs text-muted-foreground mt-2">
              {(completedTasksAndMilestones / totalTasksAndMilestones) * 100}% completion rate
            </p>
          </Card.CardContent>
        </Card.Card>
