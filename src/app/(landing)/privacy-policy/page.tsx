  ...
  return (
    <div className=" mx-auto px-6 py-20">
      ...
      <p className="mb-4 text-muted-foreground">
        Welcome to AmbitiousYou! Your privacy is important to us. This privacy policy explains how
      ...
      <p className="mb-4 pl-10 text-muted-foreground">
        ...
        update your profile, or use our services. This information may include your name, email
        address, and other personal details.
      </p>

      <h2 className="text-2xl font-semibold mb-2">2. How We Use Your Information</h2>
      <p className="mb-4 pl-10 text-muted-foreground">
        We use your information to provide, maintain, and improve our services. This includes using
        your information to:
      </p>
      ...
      <p className="mb-4 pl-10 text-muted-foreground">
        ...
        our services, comply with legal obligations, or protect our rights. This may include sharing
        information with:
      </p>
      <ul className="list-disc list-inside mb-4 pl-10 text-muted-foreground">
      ...
      <p className="mb-4 pl-10 text-muted-foreground">
        ...
        by logging into your account and updating your profile settings. If you need assistance,
        please contact us at &nbsp;<code>support@ambitiousyou.pro</code>
      </p>
