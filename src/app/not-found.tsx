      ...
      <Card className="w-full max-w-md shadow-lg border-0 bg-card">
        ...
        <CardContent className="text-center space-y-4">
          <p className="text-muted-foreground">
            We can&apos;t seem to find this page. Perhaps there was a typo in the URL, or maybe
            we&apos;re both looking in the wrong place?
          </p>
          <p className="text-sm text-muted-foreground">
            Don&apos;t worry, even the best explorers take a wrong turn sometimes. Let&apos;s get
            you back on track!
          </p>
        </CardContent>
