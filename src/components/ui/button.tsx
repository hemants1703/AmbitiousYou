...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[0.99] active:translate-y-px active:brightness-70 hover:shadow-sm active:shadow-sm transition-all duration-75 ease-in-out",
  {
    variants: {
      variant: {
        default:
          "text-primary-foreground shadow-xs bg-gradient-to-b from-primary/50 to-primary dark:from-primary dark:to-primary/50 active:from-primary/70 active:to-primary/60 dark:active:from-primary/70 dark:active:to-primary/60",
        destructive:
        ...
        "ay-secondary":
          "ay-button-secondary relative text-foreground backdrop-blur-xl border-2 border-foreground/[0.25] dark:border-foreground/[0.35] shadow-[0_1px_2px_0_rgba(0,0,0,0.04),0_4px_12px_-2px_rgba(0,0,0,0.06),inset_0_1px_2px_0_rgba(255,255,255,0.3),inset_0_0_0_1px_rgba(255,255,255,0.15)] dark:shadow-[0_1px_2px_0_rgba(0,0,0,0.2),0_4px_12px_-2px_rgba(0,0,0,0.3),inset_0_1px_2px_0_rgba(255,255,255,0.08),inset_0_0_0_1px_rgba(255,255,255,0.05)] hover:border-foreground/[0.4] dark:hover:border-foreground/[0.5] hover:shadow-[0_1px_3px_0_rgba(0,0,0,0.06),0_6px_16px_-2px_rgba(0,0,0,0.1),inset_0_2px_4px_0_rgba(255,255,255,0.4),inset_0_0_0_1px_rgba(255,255,255,0.2)] dark:hover:shadow-[0_1px_3px_0_rgba(0,0,0,0.3),0_6px_16px_-2px_rgba(0,0,0,0.4),inset_0_2px_4px_0_rgba(255,255,255,0.12),inset_0_0_0_1px_rgba(255,255,255,0.08)] active:scale-[0.98] active:shadow-[0_1px_2px_0_rgba(0,0,0,0.08),inset_0_2px_6px_0_rgba(0,0,0,0.15),inset_0_0_0_1px_rgba(255,255,255,0.1)] dark:active:shadow-[0_1px_2px_0_rgba(0,0,0,0.4),inset_0_2px_6px_0_rgba(0,0,0,0.3),inset_0_0_0_1px_rgba(255,255,255,0.05)] transition-all duration-200 ease-out",
      },
      size: {
