...
export function DashboardClient({
  firstName,
  ambitionsSummary,
  totalTasksAndMilestones,
  completedTasksAndMilestones,
  nearCompletionCount,
  motivationalQuote,
  // isProUser,
}: {
  firstName: string;
  ambitionsSummary: AmbitionSummary[];
  totalTasksAndMilestones: number;
  completedTasksAndMilestones: number;
  ...
  return (
    <TooltipProvider>
      <motion.div
        ...
        className="flex flex-col gap-10 pb-12 overflow-auto p-6 md:p-10 pt-8 bg-background min-h-screen"
      >
        {/* Welcome Banner */}
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        ...
                        style={{ background: ambition.color }}
                      />
