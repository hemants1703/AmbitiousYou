...
export default function AmbitionCard(props: AmbitionCardProps) {
  return (
    <Card.Card
      className={`bg-linear-to-b from-background to-${ambitionColorOptions.find((color) => color.value === props.ambition.ambitionColor)?.class} cursor-pointer hover:shadow-md transition-all hover:translate-y-[-2px] duration-300`}
    >
      <Card.CardHeader>
