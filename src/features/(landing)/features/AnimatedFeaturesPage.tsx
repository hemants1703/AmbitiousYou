...
import { ArrowRight, BarChart3, Check, Filter, PlusCircle, Target, X } from "lucide-react";
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description:
                  "Break down your ambition into manageable milestones and track your progress visually.",
              },
              {
                step: "3",
            ...
            >
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
                  Our platform is designed specifically for those who refuse to settle for
                  mediocrity. See how we&apos;ve helped thousands of ambitious professionals exceed
                  their goals.
                </p>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-start gap-2">
                        <Check className="h-5 w-5 mt-0.5 text-green-500 shrink-0" />
