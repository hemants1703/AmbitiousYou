              ...
              {achievements.map((achievement, i) => (
                ...
                >
                  <Card className={`
                    ...
                    ${achievement.rarity === 'common' ? 'bg-gradient-to-br from-background to-muted/50' : 
                      achievement.rarity === 'rare' ? 'bg-gradient-to-br from-background to-blue-500/10' : 
                  ...
                  `}>
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-start">
                        ...
                        >
                          {achievement.icon === 'medal' ? 
                            <Medal className={`h-6 w-6 ${
                              achievement.rarity === 'common' ? 'text-zinc-400' : 
                        ...
                        >
                          <Badge className={`
                            ${achievement.rarity === 'common' ? 'bg-zinc-200 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-200' : 
                    ...
                    <CardContent>
                      ...
                      >
                        <h3 className="font-medium text-lg mb-1">
                          {i === 1 ? 'Secret Achievement' : 
                           i === 2 ? 'Marathon Finisher' : 'Grand Master'}
                        </h3>
                        <p className="text-sm text-muted-foreground">
                          {i === 1 ? 'Continue your journey to unlock this achievement' : 
                           i === 2 ? 'Complete your first marathon ambition' :
