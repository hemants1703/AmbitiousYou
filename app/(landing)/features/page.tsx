        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              <h1
                className={`${playfair.className} text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl`}
              >
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="relative">
              ...
              <FeatureCard
                ...
                learnMoreLink="#dashboard-details"
              />
            </div>
            <FeatureCard
            ...
            <FeatureCard
              ...
              description="Monitor exactly how much time you're investing in each ambition with built-in timers and detailed time analytics."
            />
            <FeatureCard
              icon={<Zap className="h-10 w-10 text-primary" />}
              title="Visual Progress Analytics"
              description="Stay motivated with beautiful progress visualizations that show your journey and celebrate every step forward."
            />
            <FeatureCard
              icon={<Filter className="h-10 w-10 text-primary" />}
              title="Custom Organization"
              description="Categorize and prioritize your ambitions with flexible tagging, color-coding, and filtering options for perfect organization."
            />
            <FeatureCard
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                Join thousands of professionals who are achieving more than ever
                before
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="bg-background p-6 rounded-lg shadow border">
              ...
              <p className="italic">
                "I've managed to complete my MBA while working full-time, thanks
                to AmbitiousYou's structured approach to goal tracking. I
            ...
            <div className="bg-background p-6 rounded-lg shadow border">
              ...
              <p className="italic">
                "The milestone tracking feature completely changed how I
                approach my professional development. I'm now on track for a
                promotion months ahead of schedule."
              </p>
            </div>
            ...
            <div className="bg-background p-6 rounded-lg shadow border">
              ...
              <p className="italic">
                "As someone juggling multiple businesses, AmbitiousYou helps me
                stay focused on what matters. The visual progress tracking keeps
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  Unlike simple task managers, AmbitiousYou is specifically
                  designed for long-term ambition tracking with dual progress
                  methods (tasks or milestones), built-in time tracking, and
                  powerful analytics that keep you motivated and focused on your
                  biggest goals.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Yes! AmbitiousYou offers a comprehensive free plan that
                  includes up to 3 active ambitions, basic progress tracking,
                  and access to our core dashboard features. No credit card
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  We take data privacy seriously. All your information is
                  encrypted both in transit and at rest. We never sell your data
                  to third parties, and you can export or delete your
                  information at any time.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-4">
                <AccordionTrigger>
                  Can I use AmbitiousYou on all my devices?
                </AccordionTrigger>
                <AccordionContent>
                  Absolutely! AmbitiousYou works seamlessly on desktop, tablet,
                  and mobile devices with a responsive web design. Native mobile
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] md:text-xl/relaxed">
                Start for free today and see the difference in your productivity
                within the first week. No credit card required.
              </p>
            </div>
...
function FeatureCard({
  ...
  return (
    <div className="flex flex-col items-center space-y-3 rounded-lg border p-6 bg-background shadow-sm transition-all hover:shadow-md">
      ...
      {learnMoreLink && (
        <a href={learnMoreLink} className="text-primary font-medium">
          Learn More
        </a>
      )}
    </div>
