...
Here are some examples of ambitions: - "I want to lose 10 pounds"
-> Ambition: Lose 10 pounds
TrackingMethod: "task"
Tasks: Exercise 3 times a week, Eat healthier, Drink 8 glasses of water a day - "I want to run a marathon"
-> Ambition: Run a marathon
TrackingMethod: "milestone"
Milestones: Complete a 5K run, Complete a 10K run, Complete a half marathon, Complete a full marathon - "I want to learn to play the guitar"
-> Ambition: Learn to play the guitar
TrackingMethod: "milestone"
Milestones: Learn basic chords, Play a simple song, Learn barre chords, Perform a song for friends - "I want to save $1000"
-> Ambition: Save $1000
TrackingMethod: "task"
Tasks: Set a budget, Track expenses, Save $100 a month - "I want to learn to code"
