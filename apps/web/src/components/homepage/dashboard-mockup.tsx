...
import { LayoutDashboard, Moon, Plus, Settings, Target, ToggleLeft } from "lucide-react";
...
const sidebarNavItems = [
  ...
  { title: "All Ambitions", icon: Target, active: false },
  { title: "Create Ambition", icon: Plus, active: false },
];

const sidebarBottomItems = [
  { title: "Toggle Sidebar", icon: ToggleLeft },
