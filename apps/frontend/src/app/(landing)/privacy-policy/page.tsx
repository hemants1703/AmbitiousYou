...
export default function PrivacyPolicy() {
  return (
    <div className=" mx-auto px-6 py-20">
      ...
      <p className="mb-4 pl-10 text-muted-foreground">We use your information to provide, maintain, and improve our services. This includes using your information to:</p>
      <ul className="list-disc list-inside mb-4 pl-10 text-muted-foreground">
      ...
      <p className="mb-4 pl-10 text-muted-foreground">We take reasonable measures to protect your personal information from unauthorized access, use, or disclosure.</p>
