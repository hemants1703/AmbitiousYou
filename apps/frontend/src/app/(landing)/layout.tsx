  ...
  return (
    <>
      ...
      <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-secondary/10 dark:bg-secondary/20 rounded-full filter blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-primary/5 dark:bg-primary/15 rounded-full filter blur-3xl animate-pulse" style={{ animationDelay: "3s", animationDuration: "8s" }}></div>
      </div>
