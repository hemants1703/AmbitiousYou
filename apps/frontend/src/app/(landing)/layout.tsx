...
export default async function LandingLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <>
      ...
      <h1 className="relative bottom-0 left-0 right-0 translate-y-1/2 text-5xl md:text-8xl lg:text-[10rem] p-0 m-0 text-center w-full bg-clip-text text-transparent bg-linear-to-b from-foreground via-foreground/50 to-transparent">
