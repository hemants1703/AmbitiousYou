...
export const personas: Persona[] = [
  {
    ...
    story: "You're not just working a job—you're building a career. Whether it's landing that promotion, mastering a new skill, or leading your first team, you know success doesn't happen by accident. It happens by design.",
    icon: "briefcase",
    color: "#00bfff",
    ambitions: [
      {
        ambition: {
          ...
          ambitionDefinition: "Achieve senior engineer title by Q2 through demonstrated technical leadership and project delivery",
        ...
        tasks: [
          {
            id: "task-prof-1",
            ambitionId: "demo-prof-1",
            task: "Write the Project Atlas design doc",
            taskDescription: "Draft and circulate the architecture proposal for review",
            taskCompleted: true,
            taskDeadline: daysAgo(8),
          },
          {
            id: "task-prof-2",
            ambitionId: "demo-prof-1",
            task: "Publish two internal tech talks",
            taskDescription: "Share learnings on system design with the wider team",
            taskCompleted: false,
            taskDeadline: daysFromNow(40),
          },
        ],
      },
    ],
    ...
    ambitions: [
      {
        ambition: {
          ...
          ambitionDefinition: "Excel in all 6 courses while maintaining research assistant position",
          ambitionMotivation: null,
        ...
        milestones: [
          {
            id: "ms-student-1",
            ambitionId: "demo-student-1",
            milestone: "Secure research assistant renewal",
            milestoneDescription: "Confirm the RA position for next semester with the lab",
            milestoneCompleted: true,
          ...
          },
          {
            id: "ms-student-2",
            ambitionId: "demo-student-1",
            milestone: "Finish the semester with a 9+ GPA",
            milestoneDescription: "Final grades posted across all six courses",
            milestoneCompleted: false,
            milestoneTargetDate: daysFromNow(70),
          },
        ],
      },
    ],
  },
  {
    ...
    story: "You're wearing ten hats before breakfast. Product, marketing, fundraising, hiring—the chaos is real, but so is your vision. You need a system that keeps your ambitious goals organized while you build something that matters.",
    icon: "rocket",
    color: "#ff7733",
    ambitions: [
      {
        ambition: {
          ...
          ambitionDefinition: "Ship the core product and validate market fit through early adoption",
          ambitionMotivation: null,
  ...
  },
  {
    ...
    story: "Life isn't just about work—it's about becoming the best version of yourself. Whether it's running your first marathon, learning guitar, or finally mastering Spanish, you know that personal growth is the ultimate investment.",
    icon: "heart",
    color: "#32cd32",
    ambitions: [
      {
        ambition: {
          ...
          ambitionDefinition: "Complete 21.1km race in under 2 hours by the city marathon in spring",
          ambitionMotivation: null,
    ...
    ambitions: [
      {
        ambition: {
          ...
          ambitionDefinition: "Land a PM role at a tech company within 8 months through skill building and networking",
          ambitionMotivation: null,
  ...
  },
  {
    ...
    story: "You can't pick just one passion—and why should you? You're building a YouTube channel while writing a novel while launching an Etsy shop. The world tells you to focus, but you know that multiple passions fuel your creative fire.",
    icon: "palette",
    color: "#fcda03",
    ambitions: [
      {
    ...
    ambitions: [
      {
        ambition: {
          ...
          ambitionDefinition: "Build and refine a personal productivity system that maximizes deep work and minimizes friction",
          ambitionMotivation: null,
          ambitionStartDate: daysAgo(30),
          ambitionEndDate: daysFromNow(60),
          ambitionCompletionDate: null,
