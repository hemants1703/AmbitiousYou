            ...
            <Card.CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <Card.CardTitle className="flex items-center gap-2 text-lg">
                  <CircleCheckIcon aria-hidden="true" className="size-5 text-accent-brand" />
                  Moves
                </Card.CardTitle>
              ...
              <div className="space-y-3">
                {items.map((item) => {
                  ...
                  return (
                    ...
                    <label
                      key={item.id}
                      className={cn("flex cursor-pointer items-start gap-3 rounded-lg border border-l-4 p-3 transition-colors", "hover:border-accent-brand/30 hover:bg-muted/50", isCompleted && "border-green-500/20 bg-green-500/5", MOVE_KIND_STYLE[itemKind].stripe)}>
