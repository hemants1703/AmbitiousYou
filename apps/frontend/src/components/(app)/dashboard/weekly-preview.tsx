    ...
    <Card>
      ...
      <CardContent className="space-y-2">
        {props.groups.length === 0 ? (
          <div className="flex flex-col items-center gap-1.5 rounded-2xl border border-border/60 bg-muted/20 p-5 text-center">
          ...
          props.groups.map((group) => {
            ...
            return (
              <div key={group.dateKey} className="flex items-center justify-between gap-3 rounded-2xl border border-border/60 px-3 py-2">
