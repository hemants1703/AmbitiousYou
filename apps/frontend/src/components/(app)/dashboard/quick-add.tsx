      ...
      <PopoverContent align="end" className="w-80 max-w-[92vw] space-y-3">
        ...
        <ToggleGroup
          ...
          {MODES.map((option) => {
            ...
            return (
              <ToggleGroupItem key={option.value} value={option.value} variant="outline" aria-label={option.label} className="gap-1.5 data-[state=on]:border-accent-brand data-[state=on]:bg-accent-brand/5">
