...
export function MotivationBanner(props: MotivationBannerProps) {
  return (
    <Link
      ...
      <blockquote className="mt-4 line-clamp-3 wrap-anywhere border-l-2 border-primary/30 dark:border-chart-1/30 pl-3.5 text-sm leading-relaxed text-foreground/80 sm:text-base">
        {props.motivation}
      </blockquote>
    </Link>
  );
