...
interface AmbitionStatusBadgeProps {
  ...
  /**
   * List cards: hide the `STATUS` prefix so the value pill keeps room for the due date.
...
export function AmbitionStatusBadge(props: AmbitionStatusBadgeProps) {
  ...
  return (
    <div
      ...
      <span className={cn("bg-gray-200 px-2 pt-px text-black", props.adaptive && "hidden")}>STATUS</span>
