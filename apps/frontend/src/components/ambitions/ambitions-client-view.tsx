...
export default function AmbitionsClientView(props: AmbitionsClientViewProps) {
  ...
  return (
    <div className="mx-auto flex max-w-screen-2xl flex-col gap-6 p-6 pt-6 md:p-8">
      <MotionWrapper initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      ...
      <MotionWrapper initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
